          ...
          >
            ...
            <div className="mb-8">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 py-4 px-6 bg-white border-2 border-gold-500/30 rounded-lg shadow-lg hover:shadow-xl hover:border-gold-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                ...
                <span className="text-burgundy-800 font-medium text-lg group-hover:text-burgundy-900 transition-colors">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-cream-50 text-burgundy-600 font-serif">Quick email signup</span>
              </div>
            </div>
